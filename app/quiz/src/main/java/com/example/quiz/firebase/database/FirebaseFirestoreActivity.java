...
public class FirebaseFirestoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("Ques").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
        ...
        db.collection("Ques").document("B1Ybat9eglp58APtWBst").set(data).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
